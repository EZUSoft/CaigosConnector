        ...
        if bRolle : 
            ...
            while (rsAttDefs.next()):
                ...
                if rsAtt.size() == 0 :
                    ...
                    EZU9AC841489FAD40E4B1A1232B3CA9B315( EZU1FCD98CB63A64E32A30A1F171BE370F3(LayerID) + "/" + EZU1FCD98CB63A64E32A30A1F171BE370F3(rsAttDefs.value(1))+ "/"+EZU1FCD98CB63A64E32A30A1F171BE370F3(AktDefName)+"(" + str(cgEbenenTyp) + "): Kein Attribut gefunden")
