                            ...
                            if Layer.isValid(): 
                                if bGenDar: 
                                    ...
                                    if EZUC86841CA58BC4846B265D42D4397141D() < 21200 and qry4priLayerTyp == 3:
                                        ...
                                        Antw = EZUBAF63C731D2043EEB63E493676BA1E93(AktDB, User, Layer, qry4priLayerTyp, qry4priLayerID, False, iDarGruppe, bDarObjKl)
                                    else:                    

                                        Antw = EZUBAF63C731D2043EEB63E493676BA1E93(AktDB, User, Layer, qry4priLayerTyp, qry4priLayerID, True, iDarGruppe, bDarObjKl)
                                    if Antw != 'ok':
