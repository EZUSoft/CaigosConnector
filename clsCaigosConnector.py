...
class clsCaigosConnector:
    ...
    def EZU4B07243EE7524760AD9AFF93D330E846(self):
        ...
        if db :
            ...
            guiListe, bGenDar, bPrjNeu, iGruppe, b3DDar, bDBTab, intExport, bLeer, intObjKlasse, bDarObjKl = cls.EZU3B1BBFAC47624AEF82118DE7647883DE(projekt, qry)
            if guiListe:
                InStr = "','".join(guiListe)
                InStr = "'" + InStr + "'"
                ...
                c = clsQGISAction()
                c.EZU9569D8F0E36C44ACB766DB0A73364BC3(db,User,projekt,pri_gisdb,qry, bGenDar, bPrjNeu,iGruppe, b3DDar, bDBTab, intExport, bLeer, intObjKlasse, bDarObjKl)
